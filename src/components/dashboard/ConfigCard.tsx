  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg p-6 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-300 shadow-sm dark:shadow-none" onClick={handleClick}>
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Configuração do Agente</h3>
          <p className="text-sm text-gray-600 dark:text-gray-400">Personalização e configurações</p>
        </div>
      </div>
      ...
      <div className="text-center">
        <span className="text-teal-600 dark:text-teal-400 hover:text-teal-700 dark:hover:text-teal-300 transition-colors">Configurar agente</span>
      </div>
    </div>
  );
};
